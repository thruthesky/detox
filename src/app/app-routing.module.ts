...
const routes: Routes = [
  ...
  { path: 'home-training/:name', loadChildren: () => import('./pages/home-training/home-training.module').then(m => m.HomeTrainingPageModule) },
  { path: 'home-training-item/:name/:ID', loadChildren: () => import('./pages/home-training-item/home-training-item.module').then(m => m.HomeTrainingItemPageModule) },
