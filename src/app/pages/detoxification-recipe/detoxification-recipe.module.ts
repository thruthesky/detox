...
import { DetoxificationRecipePage } from './detoxification-recipe.page';
...
const routes: Routes = [
  {
    path: '',
    component: DetoxificationRecipePage
  }
];
...
@NgModule({
  ...
  declarations: [DetoxificationRecipePage]
})
export class DetoxificationRecipePageModule {}
